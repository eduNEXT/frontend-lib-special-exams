...
describe('Data layer integration tests', () => {
  ...
  describe('Test startProctoredExam', () => {
    ...
    it('Should log an error on worker failure', async () => {
      ...
      axiosMock
        .onGet(fetchExamAttemptsDataUrl)
        .replyOnce(200, { exam: createdWorkerExam, active_attempt: createdWorkerAttempt });
      axiosMock
        .onGet(fetchExamAttemptsDataUrl)
        .reply(200, { exam: startedWorkerExam, active_attempt: startedWorkerAttempt });
